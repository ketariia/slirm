class Discipline:
    def __init__(self, name: str, department: Department, teacher: Teacher, hours: int, exam_type: str):
        self.name = name
...
class Teacher:
    def __init__(self, last_name: str, first_name: str, patronymic: str, department: Department, birth_year: int, employment_year: int, experience: int, position: str, gender: str, address: str, city: str, phone_number: str):
...
class Student:
    def __init__(self, last_name: str, first_name: str, patronymic: str, department: Department, birth_year: int, gender: str, address: str, city: str, phone_number: str):
        self.last_name = last_name
        self.first_name = first_name
        self.patronymic = patronymic
        self.department = department
...
class AcademicPerformance:
    def __init__(self, teacher: Teacher, discipline: Discipline, student: Student, grade: int):
        self.teacher = teacher
